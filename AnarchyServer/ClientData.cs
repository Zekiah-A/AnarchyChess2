...
public class ClientData
{
    ...
    public ClientData(IPAddress ip, int port, WebSocket socket, Account account,
    ...
    public async Task CloseAsync(WebSocketCloseStatus closeStatus, string? closeReason,
        CancellationToken? cancelToken = null)
    {
        cancelToken ??= CancellationToken.None;
